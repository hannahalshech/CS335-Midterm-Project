...
public class hotelSystem {
	...
	public static HashMap<String, ArrayList<String>> createAccount(HashMap<String, ArrayList<String>> customers, Scanner scan) {
		...
		System.out.println("Create a password for your account. Passwords must be at least 8 characters, contain at least one capital letter, at least one number, and at least one special character(!,#,$,@,&, or *): ");
